...
static void (*uib_signup_view_config_delegate_portrait)();
static void (*uib_signup_view_config_delegate_landscape)();

static void (*uib_id_find_view_config_delegate_portrait)();
static void (*uib_id_find_view_config_delegate_landscape)();

static void (*uib_pw_find_view_config_delegate_portrait)();
static void (*uib_pw_find_view_config_delegate_landscape)();

static void (*uib_pw_setting_view_config_delegate_portrait)();
static void (*uib_pw_setting_view_config_delegate_landscape)();

static void (*uib_main_view_config_delegate_portrait)();
static void (*uib_main_view_config_delegate_landscape)();

static void (*uib_add_friend_view_config_delegate_portrait)();
static void (*uib_add_friend_view_config_delegate_landscape)();

static void (*uib_chatting_room_view_config_delegate_portrait)();
static void (*uib_chatting_room_view_config_delegate_landscape)();

static void (*uib_email_certify_view_config_delegate_portrait)();
static void (*uib_email_certify_view_config_delegate_landscape)();

static void (*uib_chatting_view_config_delegate_portrait)();
static void (*uib_chatting_view_config_delegate_landscape)();

char*g_view1_config_name_portrait = NULL;
char*g_view1_config_name_landscape = NULL;

char*g_signup_view_config_name_portrait = NULL;
char*g_signup_view_config_name_landscape = NULL;

char*g_id_find_view_config_name_portrait = NULL;
char*g_id_find_view_config_name_landscape = NULL;

char*g_pw_find_view_config_name_portrait = NULL;
char*g_pw_find_view_config_name_landscape = NULL;

char*g_pw_setting_view_config_name_portrait = NULL;
char*g_pw_setting_view_config_name_landscape = NULL;

char*g_main_view_config_name_portrait = NULL;
char*g_main_view_config_name_landscape = NULL;

char*g_add_friend_view_config_name_portrait = NULL;
char*g_add_friend_view_config_name_landscape = NULL;

char*g_chatting_room_view_config_name_portrait = NULL;
char*g_chatting_room_view_config_name_landscape = NULL;

char*g_email_certify_view_config_name_portrait = NULL;
char*g_email_certify_view_config_name_landscape = NULL;

char*g_chatting_view_config_name_portrait = NULL;
char*g_chatting_view_config_name_landscape = NULL;
...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_HD:
			...
			uib_signup_view_config_delegate_portrait = &uib_signup_view_config_HD_portrait;
			g_signup_view_config_name_portrait = "common";
			uib_signup_view_config_delegate_landscape = &uib_signup_view_config_HD_portrait;
			g_signup_view_config_name_landscape = "common";

			uib_id_find_view_config_delegate_portrait = &uib_id_find_view_config_HD_portrait;
			g_id_find_view_config_name_portrait = "common";
			uib_id_find_view_config_delegate_landscape = &uib_id_find_view_config_HD_portrait;
			g_id_find_view_config_name_landscape = "common";

			uib_pw_find_view_config_delegate_portrait = &uib_pw_find_view_config_HD_portrait;
			g_pw_find_view_config_name_portrait = "common";
			uib_pw_find_view_config_delegate_landscape = &uib_pw_find_view_config_HD_portrait;
			g_pw_find_view_config_name_landscape = "common";

			uib_pw_setting_view_config_delegate_portrait = &uib_pw_setting_view_config_HD_portrait;
			g_pw_setting_view_config_name_portrait = "common";
			uib_pw_setting_view_config_delegate_landscape = &uib_pw_setting_view_config_HD_portrait;
			g_pw_setting_view_config_name_landscape = "common";

			uib_main_view_config_delegate_portrait = &uib_main_view_config_HD_portrait;
			g_main_view_config_name_portrait = "common";
			uib_main_view_config_delegate_landscape = &uib_main_view_config_HD_portrait;
			g_main_view_config_name_landscape = "common";

			uib_add_friend_view_config_delegate_portrait = &uib_add_friend_view_config_HD_portrait;
			g_add_friend_view_config_name_portrait = "common";
			uib_add_friend_view_config_delegate_landscape = &uib_add_friend_view_config_HD_portrait;
			g_add_friend_view_config_name_landscape = "common";

			uib_chatting_room_view_config_delegate_portrait = &uib_chatting_room_view_config_HD_portrait;
			g_chatting_room_view_config_name_portrait = "common";
			uib_chatting_room_view_config_delegate_landscape = &uib_chatting_room_view_config_HD_portrait;
			g_chatting_room_view_config_name_landscape = "common";

			uib_email_certify_view_config_delegate_portrait = &uib_email_certify_view_config_HD_portrait;
			g_email_certify_view_config_name_portrait = "common";
			uib_email_certify_view_config_delegate_landscape = &uib_email_certify_view_config_HD_portrait;
			g_email_certify_view_config_name_landscape = "common";

			uib_chatting_view_config_delegate_portrait = &uib_chatting_view_config_HD_portrait;
			g_chatting_view_config_name_portrait = "common";
			uib_chatting_view_config_delegate_landscape = &uib_chatting_view_config_HD_portrait;
			g_chatting_view_config_name_landscape = "common";
...
void set_targeted_view(const char* view_name) {
	...
	} else if(!strcmp(view_name,"signup_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_signup_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_signup_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_signup_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_signup_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"id_find_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_id_find_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_id_find_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_id_find_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_id_find_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"pw_find_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_pw_find_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_pw_find_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_pw_find_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_pw_find_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"pw_setting_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_pw_setting_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_pw_setting_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_pw_setting_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_pw_setting_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"main_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_main_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_main_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_main_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_main_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"add_friend_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_add_friend_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_add_friend_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_add_friend_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_add_friend_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"chatting_room_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_chatting_room_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_chatting_room_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_chatting_room_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_chatting_room_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"email_certify_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_email_certify_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_email_certify_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_email_certify_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_email_certify_view_config_name_landscape;

		uib_util_rotation_set(g_win_obj->win, e_rotation_default);
	} else if(!strcmp(view_name,"chatting_view")) {
		gst_uib_views.uib_view_target_config_portrait = uib_chatting_view_config_delegate_portrait;
		gst_uib_views.uib_view_target_config_landscape = uib_chatting_view_config_delegate_landscape;

		g_views_config_delegate_name_portrait = g_chatting_view_config_name_portrait;
		g_views_config_delegate_name_landscape = g_chatting_view_config_name_landscape;
