...
Elm_Object_Item* uib_util_push_view(char *view_name) {
	...
	if(!strcmp(view_name,"view1")) {
		...
		vc = uib_view_signup_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"id_find_view")) {
		vc = uib_view_id_find_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"pw_find_view")) {
		vc = uib_view_pw_find_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"pw_setting_view")) {
		vc = uib_view_pw_setting_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"main_view")) {
		vc = uib_view_main_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"add_friend_view")) {
		vc = uib_view_add_friend_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"chatting_room_view")) {
		vc = uib_view_chatting_room_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"email_certify_view")) {
		vc = uib_view_email_certify_view_create(app_nf, NULL);
	} else if(!strcmp(view_name,"chatting_view")) {
		vc = uib_view_chatting_view_create(app_nf, NULL);
	}
